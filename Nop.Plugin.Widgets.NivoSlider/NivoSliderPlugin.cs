...
namespace Nop.Plugin.Widgets.NivoSlider
{
    ...
    public class NivoSliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        {
            return new List<string> { PublicWidgetZones.HomepageBeforeProducts };
        }
        ...
        public override void Install()
        {
            ...
            {
                Picture1Id = _pictureService.InsertPicture(_fileProvider.ReadAllBytes(_fileProvider.Combine(sampleImagesPath, "banner1.jpg")), MimeTypes.ImagePJpeg, "banner_1").Id.ToString(),
                Text1 = "",
                Link1 = _webHelper.GetStoreLocation(false),
                Picture2Id = _pictureService.InsertPicture(_fileProvider.ReadAllBytes(_fileProvider.Combine(sampleImagesPath, "banner2.jpg")), MimeTypes.ImagePJpeg, "banner_2").Id.ToString(),
                Text2 = "",
