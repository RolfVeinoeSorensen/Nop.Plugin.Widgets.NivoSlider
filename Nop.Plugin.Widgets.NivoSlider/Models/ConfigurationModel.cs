...
{
    public class ConfigurationModel : BaseNopModel, ILocalizedModel<ConfigurationModel.ConfigurationLocalizedModel>, ILocalizedModel
    {
        ...
        public IList<ConfigurationLocalizedModel> Locales
        {
            get;
            set;
        }
